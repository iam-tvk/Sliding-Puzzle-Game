...
public class Win{
    void GameCompleted() {
        ...
        {
            for (int i=0;i<9;i++){
                if (NineViews[i].getLayoutX() == DataX.get(i) && NineViews[i].getLayoutY() == DataY.get(i))
                    counter++;
            }
        ...
        if (FourXFour.isSelected()) {
            ...
            if (counter == 14 && SixteenViews[15].getLayoutX() == DataX.get(10) &&SixteenViews[15].getLayoutY() == DataY.get(10) &&SixteenViews[10].getLayoutX() == DataX.get(15) &&SixteenViews[10].getLayoutY() == DataY.get(15))
            {
...
//                SixteenViews[10].setLayoutY(DataY.get(10));
        ...
        if (FiveXFive.isSelected())
        {
            ...
            if (counter == 23 && TwentyFiveViews[24].getLayoutX() == DataX.get(18) &&TwentyFiveViews[24].getLayoutY() == DataY.get(18) &&TwentyFiveViews[18].getLayoutX() == DataX.get(24) &&TwentyFiveViews[18].getLayoutY() == DataY.get(24))
            {
